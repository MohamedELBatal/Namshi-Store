...
import 'features/home/domain/use_cases/get_Cart_use_case.dart' as _i10;
import 'features/home/domain/use_cases/get_categories_use_case.dart' as _i11;
import 'features/home/domain/use_cases/get_products_use_case.dart' as _i12;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i11.GetCategoriesUseCase>(
        () => _i11.GetCategoriesUseCase(gh<_i6.HomeRepo>()));
    ...
    gh.factory<_i13.HomeBloc>(() => _i13.HomeBloc(
          ...
          getCategoriesUseCase: gh<_i11.GetCategoriesUseCase>(),
        ));
    return this;
  }
}
